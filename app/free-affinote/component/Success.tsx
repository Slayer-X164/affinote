  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5">
      ...
      <h1 className="text-2xl md:text-4xl  font-bold flex items-center flex-col gap-3 text-green-500 mb-8 text-center">
        Free Template Claimed! <br /> <span className="text-sm md:text-lg text-blue-900 rounded-full border border-blue-900 px-3 py-1 bg-blue-600/20 font-light flex items-center gap-2 "><RiErrorWarningFill />
