      ...
      <AnimatePresence mode="wait">
        ...
        {phase == "ph3" && (
          ...
          >
            ...
            />
            <div className="rounded-2xl border-3 border-[#beab54] text-[#4b421c]  max-w-[500px] text-md font-mono font-semibold px-4 py-10 min-h-60 bg-[#f3e299] text-center relative wrap-words">
              <img
